...
let LiteVimeoEmbed = /** @class */ (() => {
    class LiteVimeoEmbed extends HTMLElement {
        ...
        get background(){
            ...
            // return encodeURIComponent(this.getAttribute('background') || '');
        }
  ...
  allowfullscreen src="${srcUrl}"></iframe>`;
        ...
        async initImagePlaceholder() {
            ...
            try {
                ...
                var posterUrlWebp = `https://i.vimeocdn.com/video/${imgId}.webp?mw=1100&mh=619&q=70`;
                var posterUrlJpeg = `https://i.vimeocdn.com/video/${imgId}.jpg?mw=1100&mh=619&q=70`;

            } catch (error) {
                console.log('Error: ' + error)
            }
            
            this.domRefImg.webp.srcset =  this.background || posterUrlWebp;
            this.domRefImg.jpeg.srcset =  this.background || posterUrlJpeg;
            this.domRefImg.fallback.src = this.background || posterUrlJpeg; 
